...
| Explicit clipboard actions | selection APIs and `paste()` | Layer 2 runtime | Connected | Bounded Android `ClipboardManager` read/write | Long press delegates selection to xterm; handles and copy/paste menu UX remain future policy |
