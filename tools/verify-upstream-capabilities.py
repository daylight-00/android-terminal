...
EXPECTED_ADDONS = {
    ...
    "@xterm/addon-clipboard": ("layer2-runtime", "connected-with-bounds", "automatic"),
    "@xterm/addon-fit": ("layer2-runtime", "connected", "automatic"),
    "@xterm/addon-image": ("layer2-runtime", "connected-with-upstream-defaults", "automatic"),
    "@xterm/addon-ligatures": ("layer2-capability", "available", "registered"),
    "@xterm/addon-progress": ("layer2-runtime", "connected", "automatic"),
    "@xterm/addon-search": ("layer2-capability", "available", "registered"),
    ...
    "@xterm/addon-unicode11": ("layer2-capability", "available", "registered"),
    "@xterm/addon-web-fonts": ("layer2-capability", "available", "registered"),
...
EXPECTED_CORE = {
    ...
    'osc52-clipboard': ('layer2-runtime', 'connected-with-bounds'),
