...
def verify(root: Path) -> list[str]:
    ...
    require("versionCode 35" in build, "versionCode must identify the floating ActionMode POC release", failures)
    require("versionName '0.27.0'" in build, "versionName must identify the floating ActionMode POC release", failures)
    ...
    require("terminal-selection-toolbar" not in html, "floating ActionMode POC must not retain a WebView toolbar", failures)
    ...
    require("layer2-android-floating-actionmode-copy-paste-select-all" in customization_js, "Layer 3 must report floating ActionMode authority", failures)
    require("ActionMode.TYPE_FLOATING" in platform_adapter and "ActionMode.Callback2" in platform_adapter and "onGetContentRect" in platform_adapter, "Layer 2 floating ActionMode implementation is incomplete", failures)
    ...
    require("android-floating-selection-actionmode" in terminal_contract and "android-floating-selection-actionmode" in contract_js, "floating ActionMode native capability must match", failures)
