...
def verify(root: Path) -> list[str]:
    ...
    require("versionCode 31" in build, "versionCode must identify the tap-only IME and buffer-selection release", failures)
    require("versionName '0.25.4'" in build, "versionName must identify the tap-only IME and buffer-selection release", failures)
    ...
    require("no-touchstart-blur-tap-only-focus-ime" in customization_js, "Layer 3 must not blur xterm on touchstart and may request IME only for a completed tap", failures)
